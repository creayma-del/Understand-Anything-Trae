# Contributing to Understand Anything Trae

Thank you for your interest in contributing to Understand Anything Trae! This document provides guidelines and instructions for contributing to the project.
...
1. **Fork and Clone**
   ```bash
   git clone https://github.com/YOUR_USERNAME/Understand-Anything-Trae.git
   cd Understand-Anything-Trae
   ```
...
4. **Run Tests**
   ```bash
   pnpm --filter @understand-anything-trae/core test
   pnpm --filter @understand-anything-trae/skill test
   ```
...
pnpm --filter @understand-anything-trae/core test --watch
```
...
**Thank you for contributing to Understand Anything Trae! Your contributions help make code understanding accessible to everyone.** 🚀
