 ...
 *
 * Input:  <project-root>/.understand-anything-trae/intermediate/scan-result.json
 * Output: <project-root>/.understand-anything-trae/intermediate/batches.json
 */
...
async function main() {
  ...
  const scanPath = join(projectRoot, '.understand-anything-trae', 'intermediate', 'scan-result.json');
  ...
  const outPath = join(projectRoot, '.understand-anything-trae', 'intermediate', 'batches.json');
