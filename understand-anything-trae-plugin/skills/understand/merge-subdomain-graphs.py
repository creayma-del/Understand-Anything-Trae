...
Auto-discovers *knowledge-graph*.json files in .understand-anything-trae/
...
Output:
    <project-root>/.understand-anything-trae/knowledge-graph.json
"""
...
def main() -> None:
    ...
    ua_dir = project_root / ".understand-anything-trae"
