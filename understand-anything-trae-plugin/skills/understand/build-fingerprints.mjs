 ...
 * (Phase 7 step 2.5), generating .understand-anything-trae/fingerprints.json.
 *
 ...
 *
 * Writes: <projectRoot>/.understand-anything-trae/fingerprints.json
...
// ---------------------------------------------------------------------------
// Resolve @understand-anything-trae/core (matches extract-structure.mjs).
