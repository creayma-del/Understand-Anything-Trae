...
describe("persistence", () => {
  ...
  describe("saveGraph / loadGraph", () => {
    it("should write knowledge-graph.json to .understand-anything-trae/", () => {
      saveGraph(tempDir, sampleGraph);

      const filePath = join(tempDir, ".understand-anything-trae", "knowledge-graph.json");
  ...
  describe("saveMeta / loadMeta", () => {
    it("should write meta.json to .understand-anything-trae/", () => {
      saveMeta(tempDir, sampleMeta);

      const filePath = join(tempDir, ".understand-anything-trae", "meta.json");
      expect(existsSync(filePath)).toBe(true);
    });
  ...
  describe("saveFingerprints / loadFingerprints", () => {
    ...
    it("should return null when fingerprints.json is corrupted", () => {
      const dir = join(tempDir, ".understand-anything-trae");
