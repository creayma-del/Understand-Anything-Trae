...
describe("IgnoreFilter", () => {
  ...
  beforeEach(() => {
    ...
    mkdirSync(join(testDir, ".understand-anything-trae"), { recursive: true });
  });
  ...
  describe("createIgnoreFilter with user .understandignore", () => {
    it("reads patterns from .understand-anything-trae/.understandignore", () => {
      writeFileSync(
        join(testDir, ".understand-anything-trae", ".understandignore"),
        "# Exclude tests\n__tests__/\n*.test.ts\n"
      );
      const filter = createIgnoreFilter(testDir);
    ...
    it("merges .understand-anything-trae/ and root .understandignore", () => {
      writeFileSync(
        join(testDir, ".understand-anything-trae", ".understandignore"),
        "__tests__/\n"
      );
