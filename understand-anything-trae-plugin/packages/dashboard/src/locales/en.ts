export const en = {
  common: {
    ...
    appName: "Understand Anything Trae",
  ...
  onboarding: {
    header: "UNDERSTAND-ANYTHING-TRAE · GET STARTED",
    ...
    steps: [
      {
        ...
        body: "The dots and lines you see are entities and relations Understand-Anything-Trae extracted from this project. A node can be a file, class, or function from the code — or a concept, entity, or claim from a knowledge wiki.",
