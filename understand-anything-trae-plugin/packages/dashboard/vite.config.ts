...
function graphFileCandidates(fileName: string): string[] {
  ...
  return [
    ...(graphDir
      ? [path.resolve(graphDir, `.understand-anything-trae/${fileName}`)]
      : []),
    path.resolve(process.cwd(), `.understand-anything-trae/${fileName}`),
    path.resolve(process.cwd(), `../../../.understand-anything-trae/${fileName}`),
  ];
}
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@understand-anything-trae/core/schema": path.resolve(__dirname, "../core/dist/schema.js"),
      "@understand-anything-trae/core/search": path.resolve(__dirname, "../core/dist/search.js"),
      "@understand-anything-trae/core/types": path.resolve(__dirname, "../core/dist/types.js"),
    },
  },
        ...
        server.middlewares.use((req, res, next) => {
          ...
          for (const candidate of candidates) {
            ...
            try {
              ...
              console.error("[understand-anything-trae] Failed to sanitise graph file:", err);
              res.statusCode = 500;
              res.setHeader("Content-Type", "application/json");
